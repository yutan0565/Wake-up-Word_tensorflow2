...
get_gzipped_model_size(Config.prun_09_tflite_file_path)
get_gzipped_model_size(Config.prun_95_tflite_file_path)
get_gzipped_model_size(Config.prun_98_tflite_file_path)
get_gzipped_model_size(Config.prun_99_tflite_file_path)
...
model_name_detect = "tflite_pruning_09_detect_wuw_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_wake_word, Config.target_list,
                      Config.prun_09_tflite_file_path, model_type,x_test_detect,
                      y_test_detect, model_name_detect,
                      x_train_detect, y_train_detect, x_val_detect, y_val_detect
                      )

model_name_detect = "tflite_pruning_96_detect_wuw_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_wake_word, Config.target_list,
                      Config.prun_95_tflite_file_path, model_type,x_test_detect,
                      y_test_detect, model_name_detect,
                      x_train_detect, y_train_detect, x_val_detect, y_val_detect
                      )

model_name_detect = "tflite_pruning_98_detect_wuw_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_wake_word, Config.target_list,
                      Config.prun_98_tflite_file_path, model_type,x_test_detect,
                      y_test_detect, model_name_detect,
                      x_train_detect, y_train_detect, x_val_detect, y_val_detect
                      )

model_name_detect = "tflite_pruning_99_detect_wuw_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_wake_word, Config.target_list,
                      Config.prun_99_tflite_file_path, model_type,x_test_detect,
                      y_test_detect, model_name_detect,
                      x_train_detect, y_train_detect, x_val_detect, y_val_detect
                      )
...
get_gzipped_model_size(Config.prun_09_tflite_file_path_recog)
get_gzipped_model_size(Config.prun_95_tflite_file_path_recog)
get_gzipped_model_size(Config.prun_98_tflite_file_path_recog)
get_gzipped_model_size(Config.prun_99_tflite_file_path_recog)
...
model_name_recog = "tflite_pruning_09_recog_user_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_user, Config.user_list,
                      Config.prun_09_tflite_file_path_recog, model_type, x_test_recog,
                      y_test_recog, model_name_recog,
                      x_train_recog, y_train_recog, x_val_recog, y_val_recog
                      )

model_name_recog = "tflite_pruning_95_recog_user_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_user, Config.user_list,
                      Config.prun_95_tflite_file_path_recog, model_type, x_test_recog,
                      y_test_recog, model_name_recog,
                      x_train_recog, y_train_recog, x_val_recog, y_val_recog
                      )

model_name_recog = "tflite_pruning_98_recog_user_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_user, Config.user_list,
                      Config.prun_98_tflite_file_path_recog, model_type, x_test_recog,
                      y_test_recog, model_name_recog,
                      x_train_recog, y_train_recog, x_val_recog, y_val_recog
                      )

model_name_recog = "tflite_pruning_99_recog_user_matrix.jpg"
model_type = "Float"
evaluate_tflite_model(Config.target_user, Config.user_list,
                      Config.prun_99_tflite_file_path_recog, model_type, x_test_recog,
                      y_test_recog, model_name_recog,
                      x_train_recog, y_train_recog, x_val_recog, y_val_recog
                      )
